...
The style files in the project are stored in `@uiron/styles`, which includes some global styles, such as reset styles, global variables, etc. It inherits the styles and capabilities of `@uiron-core/design` and can be overridden according to project needs.
