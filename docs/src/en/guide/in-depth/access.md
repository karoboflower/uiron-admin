...
With the permission codes, you can use the `AccessControl` component and API provided by `@uiron/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@uiron/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@uiron/access';
</script>
...
```vue
<script lang="ts" setup>
import { useAccess } from '@uiron/access';
