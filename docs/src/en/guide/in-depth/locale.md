...
import { updatePreferences } from '@uiron/preferences';
...
- Do not place business translation texts inside `@uiron/locales` to better manage business and general translation texts.
...
With `@uiron/locales`, you can easily use translation texts:
