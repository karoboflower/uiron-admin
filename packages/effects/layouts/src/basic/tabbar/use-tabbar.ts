...
import type { TabDefinition } from '@uiron/types';

import type { IContextMenuItem } from '@uiron-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@uiron/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@uiron/locales';
import { useAccessStore, useTabbarStore } from '@uiron/stores';
import { filterTree } from '@uiron/utils';
