...
import type { MenuRecordRaw } from '@uiron/types';

import { computed, useSlots, watch } from 'vue';

import { useRefresh } from '@uiron/hooks';
import { $t, i18n } from '@uiron/locales';
import {
  preferences,
  updatePreferences,
  usePreferences,
} from '@uiron/preferences';
import { useLockStore } from '@uiron/stores';
import { cloneDeep, mapTree } from '@uiron/utils';

import { VbenAdminLayout } from '@uiron-core/layout-ui';
import { VbenBackTop, VbenLogo } from '@uiron-core/shadcn-ui';
