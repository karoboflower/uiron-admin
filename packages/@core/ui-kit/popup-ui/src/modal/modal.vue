...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '@uiron-core/composables';
import { Expand, Shrink } from '@uiron-core/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@uiron-core/shared/constants';
import { globalShareState } from '@uiron-core/shared/global-state';
import { cn } from '@uiron-core/shared/utils';
